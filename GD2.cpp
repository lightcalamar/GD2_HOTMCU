...
GDTR.wr(REG_ROTATE, ORIENTACION); 
...
/*  
  ...
  GD.Begin(BITMAPS);
  ColorRGB(255,255,0);  GD.Vertex2ii(200, 32, 0, 0);

  ColorRGB(255,255,255);
  cmd_text((GD.w / 2), (GD.h / 2) + 20, 27, OPT_CENTERX, "Toca el punto para calibrar la pantalla touch");
  cmd_number((GD.w / 2)-(GD.w / 13), (GD.h / 2)+(GD.h / 18)+25, 27, 0, GD.w);
  cmd_number((GD.w / 2)+(GD.w / 80), (GD.h / 2)+(GD.h / 18)+25, 27, 0, GD.h);
  cmd_text(GD.w / 2, (GD.h / 2)+(GD.h / 18)+25, 27, OPT_CENTERX, "x");
  cmd_calibrate();
  finish();
  cmd_loadidentity();
  cmd_dlstart();
...
/*
  ...
  Clear();
   ...
   GD.Begin(BITMAPS);
   GD.Vertex2ii((480 / 2)-100, 0, 0);
   ColorRGB(255,255,0);
   cmd_text(480 / 2, 195, 30, OPT_CENTERX, "ERROR");
   cmd_text(480 / 2, 225, 30, OPT_CENTERX, "Revisar comandos");
   //cmd_text(480 / 2, (272 / 2) + 3*(272 / 20), 27, OPT_CENTERX, "- Falta GD.Swap");
   //cmd_text(480 / 2, (272 / 2) + 4*(272 / 20), 27, OPT_CENTERX, "- Revisar nombre de archivo png o jpg");
   //cmd_text(480 / 2, (272 / 2) + 5*(272 / 20), 27, OPT_CENTERX, "- Grabar archivo png o jpg en la tarjeta microSD");
   //cmd_text(480 / 2, (272 / 2) + 6*(272 / 20), 27, OPT_CENTERX, "- Revisar sintaxis de instrucciones");
