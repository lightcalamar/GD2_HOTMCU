...
void Gauges() {
  ...
  GD.ClearColorRGB(0,0,0);
   ...
   if(z==1)GD.cmd_text(ox,h-10,28,OPT_CENTERX,"RIGHT"); 
	 if(z==0)GD.cmd_text(ox,h-10,28,OPT_CENTERX,"LEFT");
 ...
 */
  ...
  tgt = (analogRead(sensorPin) * w*1.58) ;
  val = rval/5;
...
void loop() { }  // NO HACE FALTA NINGUNA
